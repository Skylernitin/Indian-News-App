...
public class SportsFragment extends Fragment {
    ...
    SwipeRefreshLayout sport_refreshlayout;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sportsfragment, null);
        sport_refreshlayout = view.findViewById(R.id.sport_refreshlayout);
        recyclerView_sports = view.findViewById(R.id.recyclerView_sports);
        ...
        sport_refreshlayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        sport_refreshlayout.setRefreshing(false);
                    }
                }, 1200);
